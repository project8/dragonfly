...
print("Dripline location:", dripline.__file__)  # Debugging line to check the location of Dripline
print("Dripline Version:", dripline.__version__)  # Debugging line to check the version of Dripline
print(f"Service methods: {dir(Service)}")  # Check if 'get' is listed
import logging
    ...
    **NOTE**
    ...
    def __validate_status(self):
        ...
        if value == 'enabled':
            ...
            ThrowReply('resource_error', f"{self._status_channel} returns {value}")
